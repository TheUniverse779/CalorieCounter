...
import com.caloriecounter.calorie.databinding.FragmentNewTrendingBinding
...
@AndroidEntryPoint
class NewTrendingFragment : BaseFragment<FragmentNewTrendingBinding?>() {
    ...
    override fun getLayoutRes(): Int {
        return R.layout.fragment_new_trending
    }
    ...
    override fun initView() {
        ...
        binding?.layoutSort?.setOnClickListener {
            createSortDialog()
            WeatherApplication.trackingEvent("Click_Sort_Home")
        }
    }

    override fun initData() {
        imageAdapter = ImageAdapter(mActivity, listImage, true, true, true)
    ...
    private fun getData() {
        if (canLoadMore) {
            ...
            canLoadMore = false
            weatherViewModel.getNewTrending("60", offset)
            try {
                WeatherApplication.trackingEvent("Load_more_data_new_trending", "Offset", offset.toString())
            } catch (e: Exception) {
            }
        }
    }
    ...
    private fun createSortDialog() {
        ...
        btnNewest.setOnClickListener {
            ...
            reload()
            WeatherApplication.trackingEvent("Click_Sort_Newest_Home")
        }
        ...
        btnPopular.setOnClickListener {
            ...
            popupWindow1?.dismiss()
            reload()
            WeatherApplication.trackingEvent("Click_Sort_Popular_Home")
        }
        ...
        btnDownload.setOnClickListener {
            ...
            popupWindow1?.dismiss()
            reload()
            WeatherApplication.trackingEvent("Click_Sort_Download_Home")
        }
        ...
        btnFavorite.setOnClickListener {
            ...
            popupWindow1?.dismiss()
            reload()
            WeatherApplication.trackingEvent("Click_Sort_Favorite_Home")
        }
