...
import com.caloriecounter.calorie.databinding.DialogDownloadingBinding;
...
public class DownloadingDialog extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_downloading, container, false);
    ...
    private void setClickListener(){
        binding.btnCancelDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                WeatherApplication.trackingEvent("Click_Cancel_Download_Image");
