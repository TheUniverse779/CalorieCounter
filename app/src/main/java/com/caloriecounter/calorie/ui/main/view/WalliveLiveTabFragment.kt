...
import com.caloriecounter.calorie.databinding.FragmentWalliveLiveFragmentBinding
...
@AndroidEntryPoint
class WalliveLiveTabFragment : BaseFragment<FragmentWalliveLiveFragmentBinding?>() {
    ...
    override fun getLayoutRes(): Int {
        return R.layout.fragment_wallive_live_fragment
    }
    ...
    override fun initData() {
        imageAdapter = ImageAdapter(mActivity, listImage,true, false, false)
    ...
    private fun getData() {
        if (canLoadMore) {
            ...
            canLoadMore = false
            weatherViewModel.getLiveWallpaper( sort, "android_video", "30", offset)
            try {
    ...
    override fun setObserver() {
        weatherViewModel.liveRepos.observe(this, Observer {
