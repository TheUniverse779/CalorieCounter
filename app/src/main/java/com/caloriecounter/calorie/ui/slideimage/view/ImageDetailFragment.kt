...
@AndroidEntryPoint
class ImageDetailFragment : BaseFragment<FragmentDetailImageBinding?>(), OnClick {
...
//            Animation.RELATIVE_TO_SELF, 0.5f
//        )
//        scaleAnimation.duration = 800 // 1 second
//
//        scaleAnimation.repeatCount = Animation.INFINITE // Repeat animation infinitely
//
//        scaleAnimation.repeatMode = Animation.REVERSE
//        animationSet.addAnimation(scaleAnimation);
//        binding?.btnSetImage?.startAnimation(animationSet);
    }
...
////                        "Click_Set_Image_Detail_Image_" + listImage?.get(
...
////
////                try {
////                    mainViewModel.postAction(Constant.Action.SET, listImage?.get(vpContent.currentItem)?.id, null)
////                } catch (e: Exception) {
////                }
////
////
//////                if (preferenceUtil.getValue(Constant.SharePrefKey.SHOW_REWARD, "no")
//////                        .equals("yes")
//////                ) {
...
//        }
        ...
        btnDownload.setOnClickListener {
            ...
            if (ContextCompat.checkSelfPermission(
                ...
                if (preferenceUtil.getValue(Constant.SharePrefKey.NEW_REWARD, "no").equals("yes")) {
        ...
        vpContent.addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
            ...
            override fun onPageSelected(position: Int) {
                ...
                try {
                    WeatherApplication.trackingEvent(
                        "Change_Slide_Detail_Image_" + listImage?.get(
                            vpContent.currentItem
                        )?.content_type
                    )
                } catch (e: Exception) {
