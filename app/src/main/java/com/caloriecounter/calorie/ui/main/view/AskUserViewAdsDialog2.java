...
public class AskUserViewAdsDialog2 extends BaseDialogFragment {
    private DialogAskUserViewAds2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_ask_user_view_ads_2, container, false);
        setLabel();
