...
import com.caloriecounter.calorie.databinding.DialogSetWallpaperSuccessBinding;
import com.caloriecounter.calorie.ui.slideimage.event.OnDialogDismiss;

import org.greenrobot.eventbus.EventBus;


public class SetImageSuccess extends BaseDialogFragment {
    private DialogSetWallpaperSuccessBinding binding;
    private String description;
    private String label;
    private ClickButton clickButton;

    public static SetImageSuccess newInstance(String description, String label, ClickButton clickButton) {
        SetImageSuccess oneButtonTitleDialog = new SetImageSuccess();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_set_wallpaper_success, container, false);
        setLabel();
