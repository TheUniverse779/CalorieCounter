...
@AndroidEntryPoint
class SpecialTabFragment : BaseFragment<FragmentSpecialBinding?>() {
    ...
    override fun initView() {
        binding?.swipeToRefresh?.setOnRefreshListener {
            reload()
            WeatherApplication.trackingEvent("Refresh_Exclusive")
        }
    }
    ...
    private fun getData() {
        if (canLoadMore) {
            ...
            canLoadMore = false
            weatherViewModel.getImagesByCatId(null, sort, type, null,"60", offset)

            try {
                WeatherApplication.trackingEvent("Load_more_data_Exclusive", "Offset", offset.toString())
            } catch (e: Exception) {
            }
        }
    }
    ...
    override fun setListener() {
        binding?.layoutSort?.setOnClickListener {
            createSortDialog()
            WeatherApplication.trackingEvent("Click_Sort_Exclusive")
        }
    ...
    private fun createSortDialog() {
        ...
        btnNewest.setOnClickListener {
            ...
            reload()
            WeatherApplication.trackingEvent("Click_Sort_Newest_Exclusive")
        }
        ...
        btnPopular.setOnClickListener {
            ...
            popupWindow1?.dismiss()
            reload()
            WeatherApplication.trackingEvent("Click_Sort_popular_Exclusive")
        }
        ...
        btnDownload.setOnClickListener {
            ...
            popupWindow1?.dismiss()
            reload()
            WeatherApplication.trackingEvent("Click_Sort_download_Exclusive")
        }
        ...
        btnFavorite.setOnClickListener {
            ...
            popupWindow1?.dismiss()
            reload()
            WeatherApplication.trackingEvent("Click_Sort_favorite_Exclusive")
        }
