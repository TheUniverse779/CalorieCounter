...
import com.caloriecounter.calorie.databinding.DialogOptionAfterVideoDownloadedBinding;
import com.caloriecounter.calorie.iinterface.OnClick;


public class OptionAfterVideoDownloadDialog extends BottomSheetDialogFragment {
    private DialogOptionAfterVideoDownloadedBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.dialog_option_after_video_downloaded, container, false);
