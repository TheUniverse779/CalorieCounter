...
public class LoadAllVideoFromFolder extends AsyncTask<Void, Void, List<WallpaperCard>> {
    ...
    private List<WallpaperCard> imageList;
    ...
    @Override
    protected List<WallpaperCard> doInBackground(Void... voids) {
        loadLocalImage();
        return imageList;
    }

    @Override
    protected void onPostExecute(List<WallpaperCard> localImages) {
...
//                        imageList.add(localImage);
    ...
    public interface OnLoadDoneListener {
        void onLoadDone(List<WallpaperCard> images);
