...
//        builder.withNativeAdOptions(adOptions);
    ...
    public static void showExitDialog(Activity context) {
        ...
        View dialogView = inflater.inflate(R.layout.dialog_exit_app, null);
        dialogBuilder.setView(dialogView);
        dialogBuilder.setCancelable(false);
        AlertDialog ratingAlertDialog   = dialogBuilder.create();
        Window window = ratingAlertDialog.getWindow();
        window.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        Button btnCancel = dialogView.findViewById(R.id.btn_cancel);
        FrameLayout flNative = dialogView.findViewById(R.id.fl_native);
        ShimmerFrameLayout loadingView = dialogView.findViewById(R.id.shimmer_view_container);
        NativeAdsExitApp.initNativeAds(context,context, flNative, new CallBackNativeAds() {
            @Override
